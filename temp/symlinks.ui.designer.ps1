...
[System.Windows.Forms.Panel]$BackgroundPanel = $null
[System.Windows.Forms.TableLayoutPanel]$MainTablePanel = $null
[System.Windows.Forms.TableLayoutPanel]$RightTablePanel = $null
[System.Windows.Forms.TableLayoutPanel]$SubmitTablePanel = $null
[System.Windows.Forms.Button]$SubmitButton = $null
[System.Windows.Forms.FlowLayoutPanel]$TokenizedFiltersFlowPanel = $null
[System.Windows.Forms.TableLayoutPanel]$TokenFilterLabelPanel = $null
[System.Windows.Forms.TableLayoutPanel]$ExcludeTablePanel = $null
[System.Windows.Forms.Label]$ExcludeLabel = $null
[System.Windows.Forms.TextBox]$ExcludeTextBox = $null
[System.Windows.Forms.TableLayoutPanel]$TokenizedFiltersHeaderTablePanel = $null
[System.Windows.Forms.Label]$TokenizedFiltersHeaderLabel = $null
[System.Windows.Forms.TableLayoutPanel]$LeftTablePanel = $null
[System.Windows.Forms.TreeView]$AssetsTreeView = $null
[System.Windows.Forms.TableLayoutPanel]$FolderBrowserTable = $null
[System.Windows.Forms.TextBox]$FolderBrowserTextBox = $null
[System.Windows.Forms.Button]$FolderBrowserButton = $null
...
function InitializeConfig {
    ...
    function Save-Config {
        ...
        $content = $config.GetEnumerator() | ForEach-Object { "$($_.Key)=$($_.Value)" }
        $content | Set-Content -Path $filePath -Encoding UTF8
    }
    $configFile = $(Get-ChildItem -Path $PSScriptRoot -Recurse -File | Where-Object { $_.Name -eq "symlinks.config" }).FullName
    if (-not $configFile) {
        $configFile = "$PSScriptRoot/config/symlinks.config"
    }
    ...
    $global:BaseAssetsPath = $config.BaseAssetsPath

    if ([string]::IsNullOrEmpty($BaseAssetsPath)) {
        Add-Type -AssemblyName System.Windows.Forms
        ...
        if ($folderDialog.ShowDialog() -eq [DialogResult]::OK) {
            $global:BaseAssetsPath = $folderDialog.SelectedPath
            $config.BaseAssetsPath = $BaseAssetsPath
            Save-Config -filePath $configFile -config $config
            Write-Host "Selected Source Directory: $BaseAssetsPath"
        }
        else {
...
#TokenFilterElement
#
class TokenFilterElement : TableLayoutPanel {
    ...
    [void]Init([TreeNode]$Node) {
        ...
        $this.ColumnCount = [System.Int32]1
        ...
        $this.ColumnStyles.Add((New-Object -TypeName ColumnStyle -ArgumentList @([SizeType]::AutoSize)))
        $this.ColumnStyles.Add((New-Object -TypeName ColumnStyle -ArgumentList @([SizeType]::Percent, [Single]5)))
        $this.MaximumSize = (New-Object -TypeName Size -ArgumentList @([Int32]300, [Int32]40))
        $this.AutoSize = $true
    ...
    [void]SetControls() {
        $_TextBox = $this.BuildTextBox()
        $_Label = $this.BuildLabel()
        $this.Controls.Add($_Label, 0, 0)
        $this.Controls.Add($_TextBox, 0, 0)
        # $_TextBox = $this.BuildTextBox()
        # $this.Controls.Add($_Label, 0, 0)
        # $this.Controls.Add($_TextBox, 1, 0)
    }
    ...
    [Label]BuildLabel() {
        ...
        $_Label.MaximumSize = (New-Object -TypeName System.Drawing.Size -ArgumentList @([Int32]150, [Int32]30))
        $_Label.MinimumSize = (New-Object -TypeName System.Drawing.Size -ArgumentList @([Int32]0, [Int32]30))
    ...
    [TextBox]BuildTextBox() {
        ...
        $_TextBox.Name = [System.String]"TokenFilterTextBox_$($this.Text)"
        $_TextBox.AutoSize = $true
        $_TextBox.MaximumSize = (New-Object -TypeName System.Drawing.Size -ArgumentList @([Int32]150, [Int32]60))
        $_TextBox.MinimumSize = (New-Object -TypeName System.Drawing.Size -ArgumentList @([Int32]0, [Int32]60))
        $_TextBox.Margin = [Padding]::new(0, 6, 0, 6)
        # $_TextBox.Padding = [Padding]::new(6, 0, 6, 0)
        $_TextBox.Text = $this.Text
        $_TextBox.Tag = "$([Path]::GetDirectoryName($this.Text))\"
...
function InitializeComponents {
    ...
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute("PSUseDeclaredVarsMoreThanAssignments", "", Target = "BaseAssetsPath")]
    $BaseAssetsPath = ""
